      ...
      <main className="flex justify-center items-center">
        <div className="flex flex-col justify-between gap-4">
          ...
          <p className="page-text text-theme-black dark:text-theme-white">
            ...
            adapting and innovating. Explore the stories behind each, including
            Turmerry.com – where I led a major redesign – and many more that
            highlight my technical skills and creative problem-solving.
          </p>
        </div>
      </main>
      <section>
