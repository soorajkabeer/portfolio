...
export const WhatsappIcon = ({ className, ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <path d="M69.7 232.4c17.8 9.8 37.9 15 58.3 15 66.7 0 121-54.3 121-121s-54.3-121-121-121S7 59.7 7 126.4c0 21.4 5.6 42.4 16.4 60.9L8 250.6l61.7-18.2zm6.4-162.5c2.6-2.4 5.9-3.6 9.4-3.6h3.7c4.9 0 9.2 3.1 10.9 7.6l7.5 20.8c.7 2 .4 4.1-.9 5.8l-6 7.4c-2.4 2.9-3 6.9-1.6 10.3 7.2 18.2 28.7 30.9 39.9 36.6 4.1 2 8.9 1.3 12.2-1.9l6.6-6.6c1.6-1.6 3.9-2.1 6.1-1.5l20 6.4c4.8 1.5 8.1 6 8.1 11v5.1c0 3.7-1.5 7.3-4.1 9.9-19.5 19.2-51.8 5.1-72.7-7.7-15.1-9.3-28.2-21.4-38-36.2-23.8-35.8-9.5-55.8-1.1-63.4z" />
  </svg>
);

export const CalenderIcon = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    style={{
    ...
    {...rest}
  >
    <path d="M187.8 128h-17.1v42.7c0 2.3.9 4.4 2.5 6.1l25.6 25.6 12.1-12.1-23.1-23V128z" />
    <path d="M239 51.2c0-14.1-11.5-25.6-25.6-25.6v-8.5h-17.1v8.5h-59.8v-8.5h-17.1v8.5H59.7v-8.5H42.6v8.5h-8.5C20 25.6 8.5 37.1 8.5 51.2v145.1c0 14.1 11.5 25.6 25.6 25.6h100c28.3 24.9 71.5 22.1 96.4-6.2 10.9-12.4 17-28.4 17-45 0-11.5-2.9-22.9-8.5-32.9V51.2zM25.6 68.3V51.2c0-4.7 3.8-8.5 8.5-8.5h8.5v8.5h17.1v-8.5h59.8v8.5h17.1v-8.5h59.8v8.5h17.1v-8.5c4.7 0 8.5 3.8 8.5 8.5v17.1H25.6zm153.6 153.6c-28.3 0-51.2-22.9-51.2-51.2s22.9-51.2 51.2-51.2 51.2 22.9 51.2 51.2-22.9 51.2-51.2 51.2z" />
  </svg>
);
